...
const KEY_DATA = 'data-vue-inspector';
const KEY_IGNORE = 'data-vue-inspector-ignore';
const POSITION_DATA = 'data-vue-inspector-position';
...
const getStyles = (position) =>
  `.vue-inspector-container{height:20px;width:100px;cursor:pointer;position:fixed;text-align:center;z-index:2147483647;font-family:Arial,Helvetica,sans-serif;top:${position.top};left:${position.left};bottom:${position.bottom};right:${position.right}}.vue-inspector-banner{display:none;position:absolute;margin:0;padding:5px;width:260px;border-radius:3px;font-weight:500;font-size:11px;color:#e9e9e9;background-color:#42b883;text-decoration:none;top:100%;right:0}.vue-inspector-banner span{display:block;font-size:12px;color:#213547;font-weight:700}.vue-inspector-container:hover .vue-inspector-banner{display:block}.vue-inspector-container--disabled:hover .vue-inspector-banner{display:none}.vue-inspector-overlay{z-index:2147483647;position:fixed;padding:5px 8px;border-radius:4px;text-align:left;color:#e9e9e9;background-color:#42b883;transform:translateX(-50%);left:50%;transition:all .1s ease-in;pointer-events:none;font-family:Arial,Helvetica,sans-serif;box-shadow:0 1px 3px 0 rgba(0,0,0,.1),0 1px 2px -1px rgba(0,0,0,.1)}.vue-inspector-overlay .vue-inspector-tip{font-size:11px;opacity:.7}.vue-inspector-size-indicator{z-index:2147483646;position:fixed;background-color:#42b88325;border:1px solid #42b88350;border-radius:5px;transition:all .1s ease-in;pointer-events:none}`;

const HTML = `<div data-vue-inspector-ignore="true">
<div
  class="vue-inspector-container vue-inspector-container--disabled"
>
  <svg width="100" height="19" viewBox="0 0 62 12" fill="${color.disabled}" class="vue-inspector-icon"
  >
  ...
  <a
    ...
    href="https://github.com/hunghg255/rsbuild-plugin-vue-inspector"
    target="_blank"
  >
    <span>rsbuild-plugin-vue-inspector</span>
...
>
  <div class="vue-inspector-content"></div>
  <div class="vue-inspector-tip">
...
function getData(el) {
  return (
    el?.attributes?.getNamedItem?.(KEY_DATA)?.value ??
...
function getElementPosition() {
  const scriptTag =
    ...
    document.querySelector('script[src*="virtual-vue-inspector-path-load.js"]');
...
function load() {
  ...
  const container = document.querySelector('.vue-inspector-container');
  const overlay = document.querySelector('.vue-inspector-overlay');
  const indicator = document.querySelector('.vue-inspector-size-indicator');
  const content = document.querySelector('.vue-inspector-content');
  const icon = document.querySelector('.vue-inspector-icon');
  ...
  icon.addEventListener('click', () => {
    if (!active) {
      ...
      container.classList.remove('vue-inspector-container--disabled');
      ...
      container.classList.add('vue-inspector-container--disabled');
